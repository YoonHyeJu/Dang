...
public class WaitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wait_okay.setOnClickListener(new View.OnClickListener() {
            ...
            if(reservationModel.uidOkay(reservationModel.myUiddestinationUid, reservationModel.client, reservationModel.manager)) {
            }
            else {
                Toast.makeText(getApplicationContext(), "Not okay", Toast.LENGTH_SHORT).show();
            }
