        ...
        okay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(PetUri == null || address.equals("") || SalesTitle.equals("") || hashtag1.equals("")
                    ...
                    if(!user.sizeMemo(user.memo)) {
                     Toast.makeText(getApplicationContext(), "글자 수가 많아요", Toast.LENGTH_SHORT).show();
                    }
                    if(!user.hashtagNum(user.hashtag1, user.hashtag2, user.hashtag3))  {
                        Toast.makeText(getApplicationContext(), "모두 작성하지 않았어요", Toast.LENGTH_SHORT).show();
                    }
