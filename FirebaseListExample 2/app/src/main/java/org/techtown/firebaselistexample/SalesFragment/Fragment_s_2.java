...
import org.techtown.firebaselistexample.ButtonClickChatActivity;
...
public class Fragment_s_2 extends Fragment {
...
//        databaseReference.addListenerForSingleValueEvent();
        ...
        adapter = new CustomAdapter(arrayList, context, new CustomAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                    Intent intent = new Intent(view.getContext(), ButtonClickChatActivity.class);
